...
{    
    try 
    {
        ...
        $jsonOutput = Invoke-WebRequest -Uri $global:authURI -Method Post -ContentType "application/json" -Body $body -TimeoutSec 600
...
{     
    try
    {
        ...
        Invoke-WebRequest -Uri $global:appsURI -Method POST -ContentType "application/json" -Headers $global:Headers -Body $appsBody -TimeoutSec 1200
